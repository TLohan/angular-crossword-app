...
export class PlayBoardComponent implements OnInit, AfterViewChecked, OnDestroy {
    ...
    constructor(private playService: PlayService, private boardService: BoardService) {
        ...
        this.playService.revealsRemainingChanged$.subscribe(_ => {
    ...
    private _revealQuestion() {
        if (this.selectedQuestion) {
            const cells = this.cellMap.getCells(this.selectedQuestion);
            const questionElement = document.getElementById(`question-${this.selectedQuestion.identifier}`);
            if (questionElement) {
            ...
            if (cells) {
                cells.forEach((cell, index) => {
                    ...
                    const answer = this.selectedQuestion.answer[index];
